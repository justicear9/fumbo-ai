...
export function PageHero({
  ...
  return (
    <section
      className={cn(
        "relative overflow-hidden bg-[#050a08] px-4 pb-16 pt-32 md:px-8 md:pb-20 md:pt-36",
        className,
      )}
    >
    ...
    <section className="relative overflow-hidden bg-[#050a08] px-4 py-20 md:px-8 md:py-28">
      ...
      <div className="relative mx-auto max-w-[1400px]">
        <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[radial-gradient(ellipse_at_top_left,rgba(36,237,164,0.18),transparent_42%),radial-gradient(ellipse_at_bottom_right,rgba(0,150,246,0.16),transparent_42%),#08140f] p-1.5">
          <div className="flex flex-col gap-8 rounded-[calc(2rem-0.375rem)] border border-white/8 bg-[#07110d]/75 px-8 py-10 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] md:flex-row md:items-end md:justify-between md:px-12 md:py-14">
            <div>
